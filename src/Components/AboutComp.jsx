  ...
  return (
    <>
      ...
      <div className='text-sm md:text-base  lg:text-xl md:w-1/2   font-normal text-gray-700'>
       ...
       <div className='md:w-1/2 flex justify-center mt-5 md:mt-0 '><img src={process.env.PUBLIC_URL + "./user.jpg"} className='border-8 rounded-tl-3xl rounded-br-3xl border-red w-[70%] sm:w-[50%] md:w-[70%] lg:w-[40%]' alt="my-pic" /></div>
