    ...
    <>
      <div className=' bg-bgimgall  bg-no-repeat bg-cover top-0'>
        <div className='container flex flex-col md:flex-row items-center justify-center md:h-screen w-full '>
          <div className='flex flex-col text-white gap-y-1 w-[70vh]  md:gap-y-3  p-4 md:w-1/2'>
          ...
          <div className='w-[60vh] md:w-1/2 flex justify-center mt-10 md:mt-0'><img src={process.env.PUBLIC_URL + "./me.jpg"} className='border-8 rounded-tl-3xl rounded-br-3xl border-red w-[70%] md:w-[50%]' width="50%" alt="my-pic" /></div>
        </div>
      </div>
